...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('charactersAssets/arthur-dead', 'shared');
				...
				setGraphicSize(Std.int(width * 0.3)); // <-- pixel bullshit (dont mind it)
				updateHitbox();
				antialiasing = false;
				flipX = true;
			...
			case 'spirit':
				...
				antialiasing = false;
			case 'teste':
				tex = Paths.getSparrowAtlas('charactersAssets/teste', 'shared');
				frames = tex;
				...
				addOffset('idle');
				addOffset("singUP", -5, 7);
				addOffset("singRIGHT", 15, -35);
				addOffset("singLEFT", 267, -136);
				addOffset("singDOWN", 183, -133);
				playAnim('idle');
			case 'arthur':
				tex = Paths.getSparrowAtlas('charactersAssets/arthur', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'idle', 24, false);
				animation.addByPrefix('singUP', 'up', 24, false);
				animation.addByPrefix('singDOWN', 'down', 24, false);
				...
				addOffset('idle', 2, 2);
				addOffset("singUP", -8, -12);
				addOffset("singRIGHT", -34, -16);
				addOffset("singLEFT", 118, -12);
				addOffset("singDOWN", -13, -80);
				playAnim('idle');
			...
			case 'arthur-dead':
				frames = Paths.getSparrowAtlas('charactersAssets/arthur-dead', 'shared');
				animation.addByPrefix('singUP', "ap up", 24, false);
				animation.addByPrefix('firstDeath', "ap dead", 24, false);
				animation.addByPrefix('deathLoop', "ap deadloop", 24, true);
				animation.addByPrefix('deathConfirm', "ap conf", 24, false);
				animation.play('firstDeath');
			...
			case 'arthur-player':
				var tex = Paths.getSparrowAtlas('charactersAssets/arthurPlayer', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'ap idle', 24, false);
				animation.addByPrefix('singUP', 'ap up', 24, false);
				animation.addByPrefix('singLEFT', 'ap left', 24, false);
				animation.addByPrefix('singRIGHT', 'ap right', 24, false);
				animation.addByPrefix('singDOWN', 'ap down', 24, false);
				...
				animation.addByPrefix('intro', 'ap intro', 24, false);
				...
				addOffset('idle', -5);
				addOffset("singUP", -48, 32);
				addOffset("singRIGHT", -32, -7);
				addOffset("singLEFT", -38, 14);
				addOffset("singDOWN", -37, -16);
				addOffset("singUPmiss", -29, 27);
				addOffset("singRIGHTmiss", -30, 21);
				addOffset("singLEFTmiss", 12, 24);
				addOffset("singDOWNmiss", -11, -19);
			...
			case 'fraud':
				tex = Paths.getSparrowAtlas('charactersAssets/fraud', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'fraud idle', 24);
				animation.addByPrefix('singUP', 'fraud up', 24, false);
				animation.addByPrefix('singDOWN', 'fraud down', 24, false);
				animation.addByPrefix('singLEFT', 'fraud left', 24, false);
				animation.addByPrefix('singRIGHT', 'fraud right', 24, false);

				animation.addByPrefix('intro', 'intro', 24, false);

				animation.addByPrefix('singUP-alt', 'fraud ouch', 24, false);

				addOffset('idle');
				addOffset("singUP", 54, 69);
				addOffset("singRIGHT", -63, -3);
				addOffset("singLEFT", 33, 7);
				addOffset("singDOWN", -29, -31);

				addOffset("singUP-alt", 215, 32);
